...
flirt -in $anat_file2 -ref $anat_file3 -omat ${anat_folder}trans_ses02_2_ses03.mat
flirt -in $anat_file3 -ref $anat_file2 -omat ${anat_folder}trans_ses03_2_ses02.mat
...
convert_xfm -omat ${func_root}reg/example_func2highres_inv2.mat -concat ${func_root}reg/example_func2highres_inv.mat ${anat_folder}trans_ses02_2_ses03.mat
